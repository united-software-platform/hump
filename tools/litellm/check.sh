#!/bin/sh
# Проверка шлюза LiteLLM: живость, готовность, состояние настроенных маршрутов и сквозной
# запрос по каждому из них.
#
# Коды возврата: 0 — все настроенные маршруты ответили; 1 — хотя бы один не ответил;
# 2 — ошибка вызова или окружения (нет HTTP-клиента, не задан ключ доступа).
#
